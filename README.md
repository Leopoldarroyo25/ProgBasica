...
Un programa en el que el usuario introduce el mes y el día. El programa debe despliega la temporada de acuerdo ala información introducida.
...
## Ejercicio 78:
Programa que convierte un numero decimal(base 10)que inserte un usuario como numero y después use el logra ritmo división mostrado para realizar la conversión.
